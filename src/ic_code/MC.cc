...
bool MC::ICCovPlus(MGStruct* pMG, MGStruct* pBestMG) {
	...
	cout << "In ICCOV";
	// creates coverage_inference.txt file to write node and respective cov value in line #611
	ofstream covFile;
	covFile.open("coverage_inference.txt", std::ios::app);
	...
	for (int b = 0; b < countIterations; b++) {
		...
		cout << "***************\n" << pMG->nodeID << "\tCOV inference: " << cov << "\n*************" << endl;
	covFile << pMG->nodeID << "\t" << cov << "\n";
